 ...
 * - Camel Case : 첫글자 소문자로 시작, 중간 단어의 첫 시작은 대문자 예) camelCase
 * - Pascal Case : 첫글자 대문자로 시작, 중간 단어의 첫 시작은 대문자 예) PascalCase
 * - Snake Case : 전체 소문자로, 중간 단어 연결시 _ 사용 예) snake_case
 * 
 * ※ 주의사항
 * - 숫자로 시작하면 안됨
...
let output = '저의 이름은 ' + myName + '이고, 나이는 ' + my_age + '살 입니다';
console.log(output);

// 템플릿 리터럴(Templete Literal) : `출력 문자 ${변수명}`(백틱)
let output2 = `저의 이름은 ${myName}이고, 나이는 ${my_age}살 입니다`;
console.log(output2);
